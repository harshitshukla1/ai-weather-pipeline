...
# ═══════════════════════════════════════════════
# CSS STYLING - RESPONSIVE & SCI-FI THEME
# ═══════════════════════════════════════════════
st.markdown("""
<style>
...
@media (max-width: 480px) {
    .block-container { padding: 0.5rem !important; padding-top: 4rem !important; }
    ...
    # ══════════════════════════════════
        ...
        if report:
            ...
            if isinstance(anom, dict) and anom.get("count", 0) > 0:
                ...
                st.success("◈ SYSTEM NOMINAL — No anomalies detected across all monitored cities")
